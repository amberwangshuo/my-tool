...
card2 = card.replace('class="plu-log"', 'class="plu-log" style="--plu-a:.3"') \
            ...
            .replace('商陆葵上了赵泽川的车，途中询问斯坦福暑期经济学课程事宜，赵泽川简短回应并推荐了 Sahni 的课。两人驱车前往商陆葵预约的葡萄牙餐厅。入座后，商陆葵主导点菜和话题节奏，两人围绕暑假安排、各自成长背景展开初步交流。赵泽川提及北京时一笔带过，商陆葵注意到这一细节但未追问。席间聊到学业压力，赵泽川称自己十二点前睡觉，商陆葵借此试探提出日后请教作业的可能，赵泽川回应：「你可以先发过来，我看看再说。」',
                     '半透明模式：把 --plu-a 调到 0.3，卡片就成了一层薄雾，聊天背景图会从底片后面透上来，星点与四角刻线仍在。这一版适合用了壁纸的界面。')
...
<p class="lede">把每轮剧情总结渲染成一张深空观测记录：编号、曝光时段、观测视场、正文注记。四角是取景刻线，右上角那道弦月是被远日照亮的冥王星。整条标题栏是折叠开关，收起后只留索引两行。</p>

<h2>01 &nbsp;展开态</h2>
<p>默认形态。底片自带偏蓝近黑的渐变与稀疏星点，不依赖聊天背景。整条标题栏可点击折叠。</p>
{card}

<h2>02 &nbsp;收起态</h2>
<p>点整条标题栏收合。收起后只剩编号与曝光时段这两行索引 —— 长对话里往回翻记录时，一屏能扫过十几条。</p>
{card3}

<h2>03 &nbsp;半透明底</h2>
<p>一行变量即可切换，用了壁纸的界面推荐这版。</p>
{card2}
